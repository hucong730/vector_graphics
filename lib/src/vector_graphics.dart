...
VectorGraphic createCompatVectorGraphic({
  ...
  RenderingStrategy strategy = RenderingStrategy.raster,
...
class _VectorGraphicWidgetState extends State<VectorGraphic> {
  ...
  static final LRUCache<_PictureKey, _PictureData> _livePictureCache =
      LRUCache<_PictureKey, _PictureData>(300);
